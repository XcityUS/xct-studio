...
export function ReferenceVideosInput({
    urls,
    onChange,
    onDurationChange,
    onUpload,
    ...
    const invalidUrlMessage = t('Enter a valid http<lpar>s<rpar> video URL');
    ...
    const addUrls = React.useCallback(
        ...
        [invalidUrlMessage, onChange, urls]
    );
    ...
    return (
        <div className='space-y-2'>
            <Label className='text-white'>{t('Reference Videos <lpar>Optional<rpar>')}</Label>
                            ...
                            {isUploading ? (
                                ...
                                <>
                                    ...
                                    <p className='text-xs text-white/60'>
                                        {urls.length ? t('Add another video') : t('Drop video here or click to upload')}
                                    </p>
            ...
            <p className='text-xs text-white/40'>
                {t(
                    'Cite as <lbrk>Video 1<rbrk> in your prompt <mdash> camera<slash>style imitation<comma> targeted edits<comma> or transitions<dot> Up to 20 MB each'
                )}
            </p>
        </div>
    );
